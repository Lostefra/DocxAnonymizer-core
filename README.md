...
In brief, the [program](https://github.com/Lostefra/DocxAnonymizer-core/blob/4b7a2aa461b80a935c0066c71dd222028a9348b1/src/main/java/docxAnonymizer/App.java#L76) accepts the following options:
```
